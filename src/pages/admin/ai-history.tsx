        ...
        },
        {
            ...
            render: (_, record) => (
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <span style={{ fontWeight: 600 }}>{record.candidateName}</span>
                    <a 
        ...
        },
        {
            ...
            render: (_, record) => (
                <a 
                    ...
                    style={{ fontWeight: 550, color: '#262626' }}
                >
                    {record.jobTitle}
                </a>
            )
        ...
        <Access permission={ALL_PERMISSIONS.FORMAT_CVS.GET_PAGINATE}>
            <div>
                <DataTable<ICvJobMatch>
                    actionRef={tableRef}
                    headerTitle="Lịch sử gợi ý công việc bằng AI"
                    rowKey="id"
                    columns={columns}
                    ...
                    {selectedRecord && (
                        <Space direction="vertical" size="large" style={{ width: '100%' }}>
                            <Descriptions title="Thông tin chung" bordered column={1} size="small">
                                ...
                                <Descriptions.Item label="Vị trí gợi ý"><b>{selectedRecord.jobTitle}</b></Descriptions.Item>
